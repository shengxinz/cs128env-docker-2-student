...
docker run -d -v "${cs128env_dir}\src:/home/vagrant/src" -v "${cs128env_dir}\.shared:/home/vagrant/.shared" -p 127.0.0.1:2222:22 --security-opt seccomp=unconfined --cap-add=SYS_PTRACE --name cs128env michaelrnowak/cpp-dev-env:latest
